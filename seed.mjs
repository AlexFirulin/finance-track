...
const supabase = createClient(
  ...
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InphdWxycGxiZ3VydGZyZXJ6dWxsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzY2NTQ2MSwiZXhwIjoyMDIzMjQxNDYxfQ.zw-3BOa7TVmZWlzAhY5MB6lMmq6BxmcylVnQ5GP2s94",
  {
    auth: { persistSession: false },
  }
);
const categories = ["Food", "Baby", "Wife"];
const {
  data: { users },
  error,
